  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-brand-900 via-brand-800 to-brand-700 text-white">
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute -right-10 bottom-0 h-80 w-80 rounded-full bg-brand-300/40 blur-3xl" />
      </div>
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-20 sm:px-6 sm:py-28">
        <div className="max-w-2xl">
          <span className="inline-flex items-center rounded-full bg-white/10 px-4 py-1.5 text-sm font-medium text-brand-100 ring-1 ring-white/20">
            Viagens seguras em todo o Brasil
          </span>
          <h1 className="mt-6 text-4xl font-bold leading-tight tracking-tight sm:text-5xl lg:text-6xl">
            Sua passagem de ônibus em poucos cliques
          </h1>
          <p className="mt-6 text-lg leading-relaxed text-brand-100 sm:text-xl">
            Encontre a melhor rota, escolha o horário ideal e finalize sua reserva
            com pagamento rápido e seguro.
          </p>
        </div>
